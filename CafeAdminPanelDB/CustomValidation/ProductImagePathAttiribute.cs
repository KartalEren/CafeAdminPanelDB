...
{
    public class ProductImagePathAttiribute : ValidationAttribute
    {
        ...
        public ProductImagePathAttiribute(params string[] imageTypes)
        {
        ...
        {
            var Product = (ProductCreateListVM)validationContext.ObjectInstance;
            var image = value;
